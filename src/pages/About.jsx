...
const About = () => {
  return (
    <section className="relative min-h-screen pt-16 flex items-center justify-center bg-black overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 py-8 text-white">
        ...
        <div className="space-y-4">
              ...
              <div className="flex justify-center items-center mb-6 mt-6">
                <div className="relative flex items-center">
                  ...
                  <div className="text-blue-400 text-4xl z-10">
                    <FaPlane className="opacity-80" />
                  </div>
                  
                  {/* Transition path with fixed arrow */}
                  <div className="relative mx-8">
                    <div className="w-32 h-1 bg-gradient-to-r from-blue-400 via-cyan-400 to-cyan-400 opacity-60"></div>
                    <div className="absolute top-1/2 right-0 transform -translate-y-1/2 translate-x-1 text-cyan-400 text-3xl">
                      <FaArrowRight className="drop-shadow-sm" />
                    </div>
                  </div>
                  
                  {/* Code icon - destination */}
                  <div className="text-cyan-400 text-4xl z-10">
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-6">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {/* 2018 - Italy */}
                <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 p-4 rounded-lg border border-cyan-500/20 hover:border-cyan-400/40 transition-all duration-300">
                  <div className="flex items-center mb-2">
                    <FaCalendarAlt className="text-cyan-400 mr-2" />
                    <span className="text-cyan-400 font-semibold">2018</span>
                    <span className="text-gray-400 text-xs ml-2">Age 18</span>
                  </div>
                  <h4 className="text-white font-semibold mb-2 text-sm">Italy Cabin Crew ✈️</h4>
                  <p className="text-gray-300 text-xs mb-2">Moved to Italy at 18 to work as cabin crew</p>
                ...
                <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 p-4 rounded-lg border border-blue-500/20 hover:border-blue-400/40 transition-all duration-300">
                  <div className="flex items-center mb-2">
                  ...
                  <h4 className="text-white font-semibold mb-2 text-sm">Customer Support Agent 💬</h4>
                  <p className="text-gray-300 text-xs mb-2">Customer support agent - honing communication skills</p>
                ...
                {/* 2021 - Dubai */}
                <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 p-4 rounded-lg border border-purple-500/20 hover:border-purple-400/40 transition-all duration-300">
                  <div className="flex items-center mb-2">
                  ...
                  <h4 className="text-white font-semibold mb-2 text-sm">Dubai Flight Attendant 🌍</h4>
                  <p className="text-gray-300 text-xs mb-2">Dubai flight attendant - visited 35+ countries</p>
                ...
                {/* 2023 - Programming */}
                <div className="bg-gradient-to-r from-green-500/10 to-cyan-500/10 p-4 rounded-lg border border-green-500/20 hover:border-green-400/40 transition-all duration-300">
                  <div className="flex items-center mb-2">
                  ...
                  <h4 className="text-white font-semibold mb-2 text-sm">Active Programming Learning 🚀</h4>
                  <p className="text-gray-300 text-xs mb-2">Started actively learning programming</p>
