...
const Home = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-start sm:items-center justify-center bg-black text-white overflow-x-hidden pt-24 sm:pt-20 pb-10">
      {/* Background gradient */}
      ...
      {/* Glow effects */}
      <div className="hidden sm:block absolute top-20 left-20 w-32 h-32 bg-cyan-500/20 rounded-full blur-2xl animate-pulse"></div>
      <div className="hidden sm:block absolute top-40 right-32 w-24 h-24 bg-blue-500/25 rounded-full blur-xl animate-pulse" style={{ animationDelay: '0.5s' }}></div>
      <div className="hidden sm:block absolute bottom-40 left-32 w-28 h-28 bg-purple-500/20 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      <div className="hidden sm:block absolute bottom-20 right-20 w-20 h-20 bg-cyan-500/30 rounded-full blur-lg animate-pulse" style={{ animationDelay: '1.5s' }}></div>
      <div className="hidden sm:block absolute top-1/2 left-16 w-36 h-36 bg-yellow-500/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      <div className="hidden sm:block absolute top-1/3 right-16 w-32 h-32 bg-green-500/20 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '2.5s' }}></div>
      <div className="hidden sm:block absolute bottom-1/3 left-24 w-24 h-24 bg-pink-500/25 rounded-full blur-xl animate-pulse" style={{ animationDelay: '3s' }}></div>
      <div className="hidden sm:block absolute top-2/3 right-24 w-28 h-28 bg-orange-500/20 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '0.3s' }}></div>
      <div className="hidden sm:block absolute top-1/4 left-1/2 w-40 h-40 bg-red-500/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.8s' }}></div>
      <div className="hidden sm:block absolute bottom-1/4 right-1/2 w-32 h-32 bg-indigo-500/20 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '2.2s' }}></div>
      <div className="hidden sm:block absolute top-3/4 left-1/2 w-36 h-36 bg-teal-500/18 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '0.8s' }}></div>
